...
| `docs/plans/completed/fix-devc-listing-descriptions.md` | Existing completed #8 plan, referenced as current-state evidence |
| `compare/00-feature-matrix.md` | Update diagnostics cleanup note if feature surface changes |
...
- Modify: `CLAUDE.md`
- Review only: `docs/plans/completed/fix-devc-listing-descriptions.md`
...
- [x] Update `compare/00-feature-matrix.md` with a dated note for Sprint 3 diagnostics cleanup.
- [x] Update `CLAUDE.md` key-file guidance if the new diagnostic changes common task mapping.
- [x] Verify `docs/plans/completed/fix-devc-listing-descriptions.md` still matches current code and tests; do not duplicate that plan.
