...
Guide for setting up CLI coding assistants to work with SAP via [VSP (vibing-steampunk)](https://github.com/marianfoo/arc-1).
...
More info: [VSP README](https://github.com/marianfoo/arc-1) | [MCP Usage Guide](https://github.com/marianfoo/arc-1/blob/main/MCP_USAGE.md)
